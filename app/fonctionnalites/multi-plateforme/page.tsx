        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <ScrollReveal delay={200} className="space-y-6 text-base sm:text-lg text-slate-650 dark:text-slate-355 leading-relaxed">
              <p>
                Connectez Instagram, LinkedIn, TikTok, Facebook, YouTube et X en quelques minutes. Creatabl se connecte via les APIs officielles de chaque plateforme pour une intégration 100% sécurisée et stable.
              </p>
              <p>
                Créez votre contenu une seule fois et adaptez-le automatiquement à chaque réseau. Formats, longueurs, hashtags — tout est optimisé par plateforme sans effort supplémentaire de votre part.
              </p>
              <p>
                L&apos;intégration Canva directe vous permet d&apos;importer vos visuels en un clic depuis votre espace Canva vers le planificateur Creatabl. Zéro copier-coller, zéro friction.
              </p>
            </ScrollReveal>
          </div>
                ...
                <div className="bg-white dark:bg-[#121118] border border-slate-200/60 dark:border-purple-950/40 rounded-2xl p-6 space-y-4 shadow-xl">
                  <div className="flex justify-between items-center pb-3 border-b border-slate-100 dark:border-purple-950/20">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-bold text-slate-800 dark:text-slate-200">Canaux de diffusion</span>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      ...
                      <div key={i} className="flex justify-between items-center p-2.5 bg-slate-50 dark:bg-[#181622] border border-slate-100 dark:border-purple-950/10 rounded-xl">
                        <div>
                          <span className="text-xs font-bold text-slate-750 dark:text-slate-250 block">{platform.name}</span>
                          <span className="text-[9px] text-slate-400">{platform.desc}</span>
                        </div>
                        <span className={`text-[9px] px-2 py-0.5 rounded font-bold ${platform.active ? "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400" : "bg-purple-100 text-purple-600 dark:bg-purple-950/50"}`}>
